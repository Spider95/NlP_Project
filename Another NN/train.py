...
def train_cnn():
	...
	train_file="D:\\My Data\\Studing\\Faculty\\4th level\\2's\\NLP\\Codes\\Final\\multi-class-text-classification-cnn-master\\data\\train.csv.zip" 
	x_raw, y_raw, df, labels = data_helper.load_data_and_labels(train_file)

	#parameter_file = sys.argv[2]
	parameter_file="D:\\My Data\\Studing\\Faculty\\4th level\\2's\\NLP\\Codes\\Final\\multi-class-text-classification-cnn-master\\parameters.json"
